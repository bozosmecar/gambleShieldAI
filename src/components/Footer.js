  ...
  return (
    <footer className="bg-gray-900 text-white w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-3 items-start">
          {/* Company Info */}
          <div>
            <h3 className="font-bold text-green-400 mb-1 text-base">GambleShield</h3>
            <p className="text-gray-400 text-xs leading-snug">
              Transparent gambling platform built by experienced players.
            </p>
          </div>
          ...
          {/* Contact & Social */}
          <div>
            <h4 className="font-bold mb-1 text-sm">Contact &amp; Social</h4>
            <p className="text-gray-400 text-xs leading-snug mb-2">
              contact@gambleshield.com &middot; support@gambleshield.com
            </p>
